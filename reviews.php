...
if (isset($_POST["submitted"])) {
    ...
    $insert_review = 
            "INSERT INTO review (user_id, login_id, feedback)
                VALUES ('"
...
<body>
    ...
    <main>    
        ...
        <form method="post">
            ...
            <textarea id="feedback" name="feedback" maxlength="300"></textarea>
        ...
        <table>
            ...
            <?php
            $result = mysqli_query($connection, "SELECT login_id, user_id, feedback FROM review");
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    echo
                        "<tr><td>".$row["login_id"]."#".$row["user_id"]."</td>"
                        ."<td style='width:90%'>".$row["feedback"]."</td></tr>";
                }
            }
            ?>
        </table>
